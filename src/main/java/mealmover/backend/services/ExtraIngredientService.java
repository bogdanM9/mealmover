...
public class ExtraIngredientService {
    ...
    public ExtraIngredientResponseDto create(ExtraIngredientCreateRequestDto requestDto) {
        ...
        if (this.repository.findByName(name).isPresent()) {
            throw new ConflictException("Extra ingredient with name " + name + " already exists");
        }
    ...
    public ExtraIngredientResponseDto getById(UUID id) {
        ...
        return this.repository
            .findById(id)
            .map(this.mapper::toDto)
            .orElseThrow(() -> new NotFoundException("Extra ingredient not found by id: " + id));
    }
    ...
    public void deleteById(UUID id) {
        ...
        if (this.repository.findById(id).isEmpty()) {
            throw new NotFoundException("Extra ingredient not found by id: " + id);
        }
