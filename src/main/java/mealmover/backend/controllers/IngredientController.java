...
public class IngredientController {
    ...
    private final IngredientMessages ingredientMessages;
    ...
    public ResponseEntity<String> deleteById(@PathVariable UUID id) {
        ...
        return ResponseEntity.ok(ingredientMessages.deleted());
    }

    @DeleteMapping
    public ResponseEntity<String> deleteAll() {
        this.service.deleteAll();
        return ResponseEntity.ok(ingredientMessages.deletedAll());
    }
}
